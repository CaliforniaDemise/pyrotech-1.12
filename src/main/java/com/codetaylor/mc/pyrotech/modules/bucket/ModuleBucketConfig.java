...
public class ModuleBucketConfig {
  ...
  public static BucketRefractory BUCKET_REFRACTORY = new BucketRefractory();

  public static class BucketRefractory
      implements Serializable {
    ...
    @Config.RangeInt(min = 0)
    public int HOT_CONTAINER_DAMAGE_PER_SECOND = 0;
    ...
    @Config.RangeInt(min = 0)
    public int HOT_PLAYER_DAMAGE_PER_SECOND = 1;
